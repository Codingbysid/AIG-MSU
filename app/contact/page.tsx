                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Weekly meetings with bi-weekly presentations</p>
                      <p className="text-sm text-muted-foreground mt-1">Location and time details sent via email</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Open to all MSU underclassmen</p>
                      <p className="text-sm text-muted-foreground mt-1">Focus on educating students about alternative investments</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-border bg-muted">
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    ...
                    reach out via email. We focus on educating underclassmen about the five main alternative asset classes.
                  </p>
                  <Button 
