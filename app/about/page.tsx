  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in-up">
              ...
              <p className="text-xl text-muted-foreground text-pretty">
                ...
                alternative investment strategies that are not open to the public and require a large pool of private capital.
              </p>
            ...
            <Card className="border-border hover:shadow-xl hover:shadow-accent/5 transition-all duration-500 hover:-translate-y-2 animate-fade-in-up">
              <CardContent className="p-8 space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  theory and real-world application in the finance industry through weekly meetings, educational series,
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16 animate-fade-in-up">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground text-balance">Asset Classes Covered</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty">
              Alternative investments are competitive investment strategies that are not open to the public and require a large pool of private capital
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-border hover:shadow-xl hover:shadow-accent/5 transition-all duration-500 hover:-translate-y-2 animate-fade-in-up">
              <CardContent className="p-6 space-y-4">
                <h3 className="text-xl font-semibold text-accent">Private Equity</h3>
                <p className="text-muted-foreground text-sm">
                  Investments in private companies, or buyouts of public companies, resulting in the delisting of the public company.
                </p>
              </CardContent>
            </Card>

            <Card className="border-border hover:shadow-xl hover:shadow-accent/5 transition-all duration-500 hover:-translate-y-2 animate-fade-in-up delay-100">
              <CardContent className="p-6 space-y-4">
                <h3 className="text-xl font-semibold text-accent">Hedge Funds</h3>
                <p className="text-muted-foreground text-sm">
                  Investment partnership between a hedge fund manager and investors that pool their money together into a fund to maximize returns and mitigate risk.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border hover:shadow-xl hover:shadow-accent/5 transition-all duration-500 hover:-translate-y-2 animate-fade-in-up delay-200">
              <CardContent className="p-6 space-y-4">
                <h3 className="text-xl font-semibold text-accent">Venture Capital</h3>
                <p className="text-muted-foreground text-sm">
                  Investments in generally high-risk/high-reward startup companies and small businesses.
                </p>
              </CardContent>
            </Card>

            <Card className="border-border hover:shadow-xl hover:shadow-accent/5 transition-all duration-500 hover:-translate-y-2 animate-fade-in-up delay-300">
              <CardContent className="p-6 space-y-4">
                <h3 className="text-xl font-semibold text-accent">Private Credit</h3>
                <p className="text-muted-foreground text-sm">
                  Non-bank corporate loans that are high-yielding illiquid investments, offered to businesses that are unable to secure financing from traditional bank lenders.
                </p>
              </CardContent>
            </Card>

            <Card className="border-border hover:shadow-xl hover:shadow-accent/5 transition-all duration-500 hover:-translate-y-2 animate-fade-in-up delay-400">
              <CardContent className="p-6 space-y-4">
                <h3 className="text-xl font-semibold text-accent">Real Estate</h3>
                <p className="text-muted-foreground text-sm">
                  Investments in real estate properties that generate income for investment purposes rather than a primary residence.
                </p>
              </CardContent>
            </Card>

            <Card className="border-border hover:shadow-xl hover:shadow-accent/5 transition-all duration-500 hover:-translate-y-2 animate-fade-in-up delay-500">
              <CardContent className="p-6 space-y-4">
                <h3 className="text-xl font-semibold text-accent">Secondaries</h3>
                <p className="text-muted-foreground text-sm">
                  Institutional investors who buy existing private equity stakes from current investors for access to mature assets, allowing current limited partners access to liquidity.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center space-y-3 animate-fade-in-up delay-200">
              ...
              <div className="text-2xl font-bold text-accent animate-counter">20+</div>
            ...
            <div className="text-center space-y-3 animate-fade-in-up delay-600">
              ...
              <div className="text-2xl font-bold text-accent animate-counter">6</div>
